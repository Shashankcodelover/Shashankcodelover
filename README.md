...
* **Tools & Environments:** Docker, Git, GitHub, VS Code, Google Antigravity

---

### 🧩 Featured Projects

* **[Phoenix — Unified Interview Prep & Hackathon Suite](https://github.com/Shashankcodelover/phoenix-interview-prep)**
  Merges hackathon discovery with STAR-story generation and adaptive mock-interview prep; boosted daily engagement by 35%. `Node.js · React · Express · MongoDB · WebRTC · LLM APIs`

* **[Placement Drive Clash Resolver](https://github.com/Shashankcodelover/-placement-clash-resolver)**
  Algorithmic engine resolving recruitment-vs-exam scheduling clashes for 5,000+ students; cut wait times by 40%. `Node.js · Express · Graph Algorithms`

* **[Smart Offline-First Attendance System](https://github.com/Shashankcodelover/-smart-attendance)**
  Offline-first attendance portal with HMAC-signed rotating QR codes to block proxy attendance. `PostgreSQL · Express · Node.js · IndexedDB · Prisma`

* **[LifeStream V3 — Geospatial Blood Logistics Dispatch Network](https://github.com/Shashankcodelover/blood-match-api)**
  Real-time blood dispatch map with AI-scored donor matching; sped up emergency matches by 65%. `React.js · Tailwind CSS · Leaflet.js · Node.js · Express`

---

### 📜 Certifications & Achievements

* 🏅 Full-Stack Development Certificate — Mimo, June 2026
* 🧪 Data Analytics Job Simulation — Deloitte Australia (via Forage), June 2026
* 🥇 Top 7, Cybersecurity Track — Technotsav 2026 National Hackathon
* 🎗️ Volunteer & Organizer — HACK-OLYMPIC 2026
